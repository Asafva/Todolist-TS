                ...
                >
                    {
                        edit ? (
                            <>
                                <input value={editTodo} ref={inputRef} onChange={(e) => setEditTodo(e.target.value)} className='todosSingleText' />
                                <span className="icon" onClick={(e) => handleEdit(e, todo.id)}><MdDoneAll /></span>
                            </>
                        ) : todo.isDone ? (
